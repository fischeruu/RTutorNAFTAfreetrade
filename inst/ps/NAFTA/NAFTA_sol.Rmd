...
libs <- c("ggplot2","dplyr","gridExtra","reshape2", "shinyEvents","maps") # character vector of all packages you load in the problem set
...
parts:
  ...
  - question: 2. What are NAFTA's member states?
    ...
    success: Perfect, you chose the correct answer!
    failure: This is not correct. Try again
...
```{r "2.3) 2", optional=TRUE, points=0, signif.digits = 3}
#< task
#trade %>%
#  filter( ??? ,Tradable==1) %>%
...
```{r "4.2 6", optional=TRUE, signif.digits = 3}
#< task
sectors_long
#>
```
